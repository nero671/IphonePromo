	...
	const createBurgerBlock = (burgerMenu) => {
		...
		burgerBtn.addEventListener('click', () => {
			...
			if(burgerMenu.classList.contains('amenu__burger-open')) {
				document.querySelector('.amenu__burger-list').style.transform = `translate3d(0px, 0px, 0px)`;
			} else {
				document.querySelector('.amenu__burger-list').style.transform = `translate3d(645px, 0px, 0px)`;
			}
